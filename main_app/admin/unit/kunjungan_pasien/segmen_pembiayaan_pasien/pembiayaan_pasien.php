...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>DATA PEMBAYARAN RS PELITA INSANI</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="main_admin_app.php?unit=beranda">Home</a></li>
          <li class="breadcrumb-item active">Segmen Pembiayaan Pasien</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-12">
        ...
        <div class="card-header">
              <div class="card-tools">
               <select class="form-control select2" style="width: 100%;" onChange="document.location.href=this.options[this.selectedIndex].value;" id="jenis" name="jenis">
                    <option selected="selected" value="?unit=pembiayaan_pasien"> Silahkan Pilih .....</option>
                    <option value="?unit=pembiayaan_pasien&action=datagrid&id=BPJ" <?php if ($id == 'BPJ') {echo "selected";}?>>Pasien BPJS</option>
				            <option value="?unit=pembiayaan_pasien&action=datagrid&id=A09" <?php if ($id == 'A09') {echo "selected";}?>>Pasien Umum</option>
                    <option value="?unit=pembiayaan_pasien&action=datagrid&id=B1" <?php if ($id == 'B1') {echo "selected";}?>>Asuransi / Pihak ke - III</option>
               </select>
              </div>
          </div>
          <div class="card-body">
