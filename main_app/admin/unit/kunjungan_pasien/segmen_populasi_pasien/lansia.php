<?php
  ...
  $sql = "SELECT 
          ...
          WHERE YEAR(r.tgl_registrasi) = '$tahun' 
                ...
                AND CAST(r.umurdaftar AS UNSIGNED) > 60 -- batas umur lebih dari 20 thn 
                AND CAST(r.umurdaftar AS UNSIGNED) < 100 -- batas umur kurang dari 59 thn
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
             <h3 class="card-title" style="text-align: center;">Kunjungan Pasien Kategori Lansia</h3>
