<?php
  ...
  $sql = "SELECT 
          ...
          WHERE YEAR(r.tgl_registrasi) = '$tahun' 
                ...
                AND CAST(r.umurdaftar AS UNSIGNED) > 20 -- batas umur lebih dari 20 thn 
                AND CAST(r.umurdaftar AS UNSIGNED) < 59 -- batas umur kurang dari 59 thn
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Berdasarkan Dewasa</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="modal-dialog">
             <div class="modal-content">
                  ...
                  <div class="modal-body" align = "left">
                       <form role="form" enctype="multipart/form-data" method="post" action="laporan/lap_poli_dewasa.php?action=tanggal" target="blank">
                            <div class="row">
