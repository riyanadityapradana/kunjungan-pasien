<?php
  ...
  $sql = "SELECT 
          ...
          WHERE YEAR(r.tgl_registrasi) = '$tahun' 
                ...
                AND CAST(r.umurdaftar AS UNSIGNED) > 0 -- batas umur lebih dari 20 thn 
                AND CAST(r.umurdaftar AS UNSIGNED) < 12 -- batas umur kurang dari 59 thn
    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Berdasarkan Anak</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-12">
        <div class="card card-primary">
          <div class="card-header">
             <h3 class="card-title" style="text-align: center;">Kunjungan Pasien Kategori Anak</h3>
