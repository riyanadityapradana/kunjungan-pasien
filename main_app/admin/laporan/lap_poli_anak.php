...
if ($action === 'tanggal') {
    ...
    if (!empty($tanggal1) && !empty($tanggal2)) {
        ...
        $sql = "SELECT p.nm_poli AS poli,
                ...
                AND CAST(r.umurdaftar AS UNSIGNED) > 0 
                AND CAST(r.umurdaftar AS UNSIGNED) < 12
...
<body>
    ...
    <div>
        ...
        <hr>
        <h4 align="center">LAPORAN BULANAN KUNJUNGAN PASIEN <p>BERDASARKAN KATEGORI ANAK</h4>
    </div>
