...
if ($action === 'tanggal') {
    ...
    if (!empty($tanggal1) && !empty($tanggal2)) {
        ...
        $sql = "SELECT p.nm_poli AS poli,
                ...
                AND CAST(r.umurdaftar AS UNSIGNED) > 13 
                AND CAST(r.umurdaftar AS UNSIGNED) < 19
...
<body>
    ...
    <div>
        ...
        <hr>
        <h4 align="center">LAPORAN BULANAN KUNJUNGAN PASIEN <p>BERDASARKAN KATEGORI REMAJA</h4>
    </div>
