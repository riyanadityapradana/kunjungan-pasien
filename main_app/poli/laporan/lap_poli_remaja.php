...
<body>
	<div>
		...
		<hr>
		<h4 align="center">LAPORAN KUNJUNGAN PASIEN <?=strtoupper($nama);?> <p>BERDASARKAN KATEGORI REMAJA</h4>
    </div>
    ...
    ?>
        <tr class="gradeU">
            ...
            <td align="center">
                <?php
                    $hitung_13 = mysqli_query($mysqli, "SELECT count(no_reg) AS jumlahbulan from reg_periksa WHERE YEAR(reg_periksa.tgl_registrasi)='$tahun' AND reg_periksa.status_lanjut = 'Ralan'AND kd_poli='$idpoli' AND CAST(reg_periksa.umurdaftar AS UNSIGNED) > 12 AND CAST(reg_periksa.umurdaftar AS UNSIGNED) < 19");
