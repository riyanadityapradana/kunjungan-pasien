     ...
     <div class="col-12">
          <div class="card">
               <div class="card-header" style="background:rgba(69, 77, 85, 1)">
                    <h3 class="card-title" style="text-align: center; color: white;">Kunjungan Pasien Berdasarkan Kategori Dewasa</h3>
                    <div class="card-tools">
                        <a href="laporan/lap_poli_dewasa.php" target="_blank" class="btn btn-tool btn-sm"> <!-- Mengarah ke laporanya -->
               ...
               <div class="card-body" style="background:rgb(227, 231, 234)">
                    <table id="example" class="table table-bordered table-striped">
                         ...
                         ?>
                            ...
                            <td align="center">
                                <?php
                                    $hitung_13 = mysqli_query($mysqli, "SELECT count(no_reg) AS jumlahbulan from reg_periksa WHERE YEAR(reg_periksa.tgl_registrasi)='$tahun' AND reg_periksa.status_lanjut = 'Ralan'AND kd_poli='$id' AND CAST(reg_periksa.umurdaftar AS UNSIGNED) > 20 AND CAST(reg_periksa.umurdaftar AS UNSIGNED) < 59");
